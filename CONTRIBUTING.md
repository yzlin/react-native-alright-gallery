...
This project is a monorepo managed using [Bun workspaces](https://bun.sh/docs/workspaces). It contains the following packages:
...
```sh
Running "AlrightGalleryExample" with {"fabric":true,"initialProps":{"concurrentRoot":true},"rootTag":1}
```
